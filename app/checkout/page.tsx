      ...
      <main className="min-h-screen flex flex-col font-sans bg-[#111111] text-white relative overflow-hidden justify-center items-center">
        ...
        <div className="max-w-2xl px-6 py-24 text-center flex flex-col items-center relative z-10">
          ...
          <p className="text-neutral-400 mb-12 text-lg font-medium">
            Cảm ơn bạn đã định hình bản sắc cùng chúng tôi. Chúng tôi đã nhận
            được đơn hàng và sẽ bắt đầu xử lý ngay lập tức.
          </p>
          <Link
            href="/"
            className="bg-[#d91a1a] text-white font-bold uppercase tracking-widest text-sm px-12 py-5 shadow-[0_4px_14px_0_rgba(217,26,26,0.39)] hover:bg-red-700 transition-all"
          >
            Về Trang Chủ
          </Link>
        </div>
      ...
      <main className="min-h-screen flex flex-col font-sans bg-[#e8e8e8] relative overflow-hidden justify-center items-center">
        <div className="max-w-3xl px-6 py-24 text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-8 leading-none">
            Giỏ Hàng <span className="text-[#d91a1a]">Trống</span>
          </h1>
          <Link
            href="/collection"
            className="bg-black text-white font-bold uppercase tracking-widest text-sm px-10 py-5 hover:bg-neutral-800 transition-all shadow-xl inline-block"
          >
            Mua Sắm Ngay
          </Link>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          <div className="w-full lg:w-2/3">
            <form
              ...
              className="bg-white p-8 md:p-12 shadow-2xl rounded-2xl border border-neutral-100"
            >
              <h2 className="text-2xl font-black uppercase tracking-tighter mb-8 border-b-4 border-black inline-block pb-1">
                Chi Tiết Giao Hàng
              </h2>
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-[#111111] text-white p-8 rounded-2xl shadow-2xl sticky top-6">
              <h2 className="text-2xl font-black uppercase tracking-tighter mb-8 border-b border-neutral-800 pb-4">
                Tóm Tắt Đơn Hàng
              </h2>
              ...
              <div className="max-h-60 overflow-y-auto mb-8 pr-4 custom-scrollbar">
                {cart.map((item) => (
                  <div
                    key={item.id}
                    className="flex justify-between mb-6 text-sm items-center"
                  >
                    <div className="flex-1 pr-4">
                      <span className="font-black text-[#d91a1a] text-lg mr-2">
                        {item.quantity}x
                      </span>
                      <span className="text-neutral-300 font-bold uppercase tracking-tight">
                        {item.name}
                      </span>
                    </div>
