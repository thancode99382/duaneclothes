  ...
  return (
    <main className="min-h-screen flex flex-col font-sans bg-[#031f41] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 w-full relative z-10 flex-1">
        <Link
          href="/"
          className="flex items-center gap-2 text-sm font-bold tracking-[0.15em] text-neutral-500 hover:text-[#d91a1a] uppercase mb-12 transition-colors w-fit"
        >
        ...
        {cart.length === 0 ? (
          <div className="bg-white/60 backdrop-blur-md border border-neutral-200 p-16 text-center shadow-2xl rounded-xl">
            <h2 className="text-3xl font-black uppercase tracking-tighter mb-4 text-neutral-800">
              Giỏ Hàng Trống
            </h2>
            <p className="text-neutral-500 font-medium mb-8">
              Đã đến lúc định hình bản sắc của bạn.
            </p>
            <Link
              href="/collection"
              className="bg-[#d91a1a] hover:bg-red-700 text-white font-bold uppercase tracking-widest text-sm px-10 py-4 shadow-[0_4px_14px_0_rgba(217,26,26,0.39)] transition-all inline-block"
            >
              Mua Sắm Ngay
            </Link>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            <div className="w-full lg:w-2/3 flex flex-col gap-6">
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-col sm:flex-row sm:items-center gap-6 p-6 bg-white shadow-xl rounded-xl border border-neutral-100 group"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-black text-[#d91a1a] text-xl">
