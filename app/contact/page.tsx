        ...
        <div className="bg-white p-10 md:p-16 shadow-2xl rounded-2xl border border-neutral-100">
          <form className="space-y-8">
            ...
            <div>
              ...
              <textarea
                rows={5}
                className="w-full border-2 border-neutral-200 p-4 rounded-lg focus:outline-none focus:border-[#d91a1a] font-medium transition-colors bg-neutral-50 focus:bg-white resize-none"
              ></textarea>
            </div>
            <button
              type="button"
              className="w-full bg-[#d91a1a] hover:bg-red-700 text-white font-bold uppercase tracking-widest text-sm px-8 py-5 shadow-[0_4px_14px_0_rgba(217,26,26,0.39)] transition-all"
            >
              Gửi Tin Nhắn
            </button>
          </form>
