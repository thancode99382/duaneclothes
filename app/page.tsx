        ...
        <div className="relative hidden z-10 w-full max-w-7xl mx-auto px-6 flex-1 flex items-center pt-8">
          <div className="w-full lg:w-[55%] flex flex-col z-20">
            ...
            <p className="text-neutral-700 max-w-[400px] mb-8 font-medium leading-relaxed">
              Duane &ndash; Bộ sưu tập áo polo streetwear cao cấp dành cho thế
              hệ trẻ. Văn hóa giới trẻ / từ năm 2026.
            </p>

            <div className="flex flex-wrap gap-4 mb-16">
              <Link
                href="/collection"
                className="bg-[#d91a1a] hover:bg-red-700 text-white font-bold uppercase tracking-widest text-sm px-8 py-4 shadow-[0_4px_14px_0_rgba(217,26,26,0.39)] transition-all"
              >
                Mua Ngay
              </Link>
          ...
          <div className="py-12 flex flex-col lg:flex-row lg:items-center justify-between gap-10">
            <div className="flex-1">
              ...
              <p className="text-neutral-400 font-medium max-w-md">
                Phiên bản giới hạn &ndash; trang phục thời thượng cho phong cách
                sống trẻ trung và năng động.
              </p>
            </div>

            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 lg:border-l border-neutral-800 lg:pl-10">
              <div>
                <p className="font-bold text-sm tracking-wider uppercase mb-1">
                  Phiên Bản Giới Hạn
                </p>
